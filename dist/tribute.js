...
var TributeSearch = function () {
    ...
    _createClass(TributeSearch, [{
        ...
        value: function filter(pattern, arr, opts) {
            ...
            if (this.tribute.collection.searchOpts.skip) return arr;
